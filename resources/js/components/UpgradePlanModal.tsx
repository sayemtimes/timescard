            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-96 overflow-y-auto">
              {filteredPlans.length > 0 ? filteredPlans.map((plan) => (
                ...
                >
                  ...
                  {(plan.business || plan.max_users || plan.storage_limit) && (
                    <div className="grid grid-cols-3 gap-2 mb-3 p-2 bg-gray-50 rounded">
                      {plan.business && (
                        <div className="text-center">
                          <div className="font-bold text-gray-900">{plan.business}</div>
                          <div className="text-xs text-gray-500">{t('Businesses')}</div>
                        </div>
                      )}
                      {plan.max_users && (
                        <div className="text-center">
