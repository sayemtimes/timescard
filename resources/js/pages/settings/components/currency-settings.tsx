    ...
    const formattedPreview = () => {
        try {
            ...
            if (currencySettings.decimalFormat === '0') {
                // For 0 decimal places, show format like 1234.00
                formattedNumber = Math.floor(amount).toString() + currencySettings.decimalSeparator + '00';
            } else {
                const fixedNumber = Number(amount).toFixed(decimalPlaces);
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                            ...
                                                            currencies.map((currency: CurrencyProps) => (
                                                                <SelectItem key={currency.id} value={currency.code}>
                                                                    <div className="flex items-center">
                                                                        ...
                                                                        {currency.is_default && currency.code !== 'XOF' && (
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="grid grid-cols-2 gap-2">
                                                ...
                                                >
                                                    <span className="mr-2">{window?.appSettings?.currencySettings?.currencySymbol || "$"}</span>100
                                                ...
                                                >
                                                    100<span className="ml-2">{window?.appSettings?.currencySettings?.currencySymbol || "$"}</span>
