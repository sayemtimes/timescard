              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">{t('NFC Video')}</h3>
                      <p className="text-sm text-gray-500">{t('Add an explainer video for NFC cards')}</p>
                    </div>
                  </div>
                  
                  <div className="space-y-3">
                    <Label htmlFor="hero_nfc_video_url">{t('NFC Video URL')}</Label>
                    <Input
                      id="hero_nfc_video_url"
                      value={getSectionData('hero').nfc_video_url || ''}
                      onChange={(e) => updateSectionData('hero', { nfc_video_url: e.target.value })}
                      placeholder={t("https://youtube.com/embed/video_id or /storage/path/to/video.mp4")}
                    />
                    <p className="text-xs text-muted-foreground">
                      {t('Enter a YouTube embed URL or direct link to a video file')}
                    </p>
                  </div>
                </div>
              </div>
