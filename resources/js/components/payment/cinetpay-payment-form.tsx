      ...
      <CardContent className="space-y-4">
        ...
        <div className="bg-muted p-4 rounded-lg">
          <div className="flex justify-between items-center">
            ...
            <span className="text-lg font-bold">{window.appSettings?.formatCurrency ? window.appSettings.formatCurrency(planPrice, { showSymbol: true }) : `${currency} ${planPrice}`}</span>
          </div>
        ...
        <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
          ...
          <ul className="text-sm text-yellow-800 space-y-1">
            <li>• {t('Mobile Money (Orange, MTN, Moov)')}</li>
            <li>• {t('Visa/Mastercard')}</li>
            <li>• {t('Bank Transfers')}</li>
            <li>• {t('Digital Wallets')}</li>
          </ul>
        </div>
