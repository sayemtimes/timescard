...
class EmailSettingController extends Controller
{
    ...
    public function index()
    {
        $settings = [
            ...
            'email_host' => getSetting('email_host', 'smtp.example.com'),
            'email_port' => getSetting('email_port', '587'),
            'email_username' => getSetting('email_username', 'user@example.com'),
            'email_password' => getSetting('email_password', ''),
            'email_encryption' => getSetting('email_encryption', 'tls'),
            'email_from_address' => getSetting('email_from_address', 'noreply@example.com'),
            'email_from_name' => getSetting('email_from_name', config('app.name', 'VITE_APP_NAME')),
        ];
        
        return Inertia::render('settings/components/email-settings', compact('settings'));
    }
    /**
    ...
    public function getEmailSettings()
    {
        $settings = [
            ...
            'fromName' => getSetting('email_from_name', config('app.name', 'VITE_APP_NAME')),
        ];
