        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted-foreground">{t('NFC Cards')}</p>
                  <h3 className="mt-2 text-2xl font-bold">{stats.totalNfcCards?.toLocaleString() || 0}</h3>
                </div>
                ...
                {topPlans.map((plan, index) => (
                  <div key={plan.name} className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                    ...
                    <div className="text-right">
                      <p className="font-semibold">{window?.appSettings?.currencySettings?.currencySymbol || "$"}{plan.revenue.toLocaleString()}</p>
